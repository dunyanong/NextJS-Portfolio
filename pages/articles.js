      ...
      <main className="bg-white px-10 lg:px-40 dark:bg-gray-900 py-6">
          <section className="min-h-screen">
            ...
            <div className="text-left p-10">
              <h2 className="text-4xl py-2 text-teal-600 font-medium md:text-4xl">Articles</h2>
              <p className="text-md py-5 leading-8 text-gray-800 md:text-l max-w-xl dark:text-slate-200">To be coming soon</p>
            </div>
